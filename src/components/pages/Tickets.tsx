          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-5">
                <h2 className="text-lg font-bold text-text-primary">Nuevo Ticket</h2>
                <button className="btn-ghost p-1" onClick={() => closeModal("newTicket")}>
                  <X className="w-5 h-5" />
                </button>
              </div>
              ...
              <div className="flex justify-end gap-2 mt-5 pt-4 border-t border-border">
                <button className="btn-secondary" onClick={() => closeModal("newTicket")}>
                  Cancelar
                </button>
